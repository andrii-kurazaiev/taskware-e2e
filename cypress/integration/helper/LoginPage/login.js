...
describe('My Helper Login Test Suite', function () {
    ...
    it('1.1 Log in as helper with valid data', function () {
    ...
    it('2.1 Log in as helper with Incorrect Password',function()  
    {
    ...
    it('2.2 Log in as helper with Incorrect email',function() 
    {
    ...
    it('2.3 Log in as helper with Incorrect email and password',function()// тут тоже самое
    {
        cy.login(loginWrong, passwordWrong, url, false);
        cy.on("uncaught:exception", (err, runnable) => {
          expect(err.message).to.include("email or password is invalid!");
